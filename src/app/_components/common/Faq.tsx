  ...
  const faqData = [
    {
      question: "予約は必要ですか？",
      answer:
        "体験を円滑に進めるために事前予約をお願いしています。予約方法や空き状況については、お電話またはウェブサイトでご確認ください。",
    },
    {
      question: "初心者でも参加できますか？",
      answer:
        "初心者の方も大歓迎です。経験豊富なスタッフが丁寧に指導しますので、安心して参加いただけます。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "渓流釣りの場合、滑りにくい靴底のものをお勧めします。また、季節に応じた動きやすい服装をご準備ください。",
    },
    // {
    ...
    // },
    {
      ...
      answer:
        "基本的な釣り道具は当施設で用意しています。ただし、着替えや帽子、日焼け止め、虫除けなどの装備はご持参ください。",
    },
  ];
